...
class PatientAllIntakes extends StatefulWidget {
  ...
  @override
  State<PatientAllIntakes> createState() => _PatientAllIntakesState();
}

class _PatientAllIntakesState extends State<PatientAllIntakes> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(children: <Widget>[
        const GenericHeader('Próximas 20 Ingestas'),
        Expanded(
          child: FutureBuilder(
            future: _getRemaining(patientID),
            builder: (BuildContext context,
                AsyncSnapshot<IntakesResponse> snapshot) {
